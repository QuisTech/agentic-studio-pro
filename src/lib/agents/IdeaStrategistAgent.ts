...
Output a JSON object with this exact schema:
{
  ...
  "layoutType": "Choose the optimal structural layout archetype: landing, storefront, kanban, feed, datatable, workspace, chat, streaming, dashboard based on the target product experience.",
  "techStack": {
...
`;
    ...
    const schema = z.object({
      ...
      layoutType: z.enum(["landing", "storefront", "kanban", "feed", "datatable", "workspace", "chat", "streaming", "dashboard", "bento", "cyber", "clinical", "studio", "ecommerce", "media", "culinary", "realestate", "edutech", "eventmason"]),
      techStack: z.object({
